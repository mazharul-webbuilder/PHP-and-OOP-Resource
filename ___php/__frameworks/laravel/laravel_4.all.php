...
// Example usage of Composer:
echo "Laravel 4.x is now fully integrated with Composer for dependency management.";
...
{{-- Yielding content to a section in a layout --}}
@yield('content')
...
// Example command to seed the database:
// php artisan db:seed
