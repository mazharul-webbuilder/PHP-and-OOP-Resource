<?php
/**
 * PHP provides various functions for working with regular expressions.
 * Here's a list of some commonly used regular expression functions in PHP:
*/
/*-------------------------------------------------------------------*/

//Performs a regular expression match and stores the matched groups in an array.

$pattern = "/w3schools/i";
$subject = "Visit W3Schools";
